...
public class Main {
    public static void main(String[] args) throws Exception{
        ...
        Solution solution = runSample(time_interval, 3);
...
//        runDefault(30);
    ...
    public static Solution runSample(int time_interval, int sample_index) throws Exception{
        ...
        while (end < Param.MAX_TIME) {
            ...
            batch.matching = new Match(batch.driverList, batch.passengerList, batch.cur_time);
            Solution cur_solution = batch.matching.match(Param.MATCH_ALGO, Param.MATCH_MODEL);
        ...
        int single_passenger = passenger_sum - match_sum - batch.passengerList.size() - solution.leave_count;
        ...
        System.out.println("match_sum" + "\t" + "single_passenger" + "\t" + "solution.leave_count");
        System.out.println(match_sum + "\t" + single_passenger + "\t" + solution.profit);
        return solution;
    }
